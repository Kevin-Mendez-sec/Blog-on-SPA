...
},{"./template":18,"./template2":19,"empty-element":3,"page":11}],18:[function(require,module,exports){
yo = require('yo-yo');
module.exports = yo`
<div>
    <h1 class="p-3"> Cultura ambiental y Desarrollo sustentable</h1>
    
        <div>
            <img class="float-left" src="escudo-uaemex.png" width="80" height="80"><img class="float-right" src="escudo-prepa.png" width="85" height="80"> 
            <h3 class="text-center p-2">
            UNIVERSIDAD AUTÓNOMA DEL ESTADO MÉXICO
            PLANTEL DR. ÁNGEL MA. GARIBAY KINTANA
            DE LA ESCUELA PREPARATORIA </h3>
        </div>
        <div>
            <h4 class="text-center p-3">Cómo el tráfico en las calles de Heriberto Henríquez y Ceboruco afecta de manera visual y auditiva a los alumnos del plantel “Dr. Ángel Ma. Garibay Kintana” y a la biodiversidad ambiental. </h4>
            <p class="p-2"> <span class="font-weight-bold"> PROFESOR: </span>  M. en DAES Jorge González Reynoso  </p>
            <p class="p-2">
               <span class="font-weight-bold">POR:</span> <br>
                    GARDUÑO GARCIA JANET <br>
                    MEJÍA HERNÁNDEZ BRENDA DULIANA <br>
        ...
        <!--INTRODUCCION-->
        <div >
            <h5 class="p-2 text-center">INTRODUCCIÓN</h5>
            <p class="p-2">
                En los últimos años el aumento de la demanda de transporte y del tránsito vial han traído como consecuencia, particularmente en las ciudades grandes, incrementos en la congestión, demoras, accidentes y problemas ambientales, bastante mayores que los considerados aceptables por los ciudadanos.
            </p>
            <p class="p-2">
                En la ciudad de Toluca, en las calles de Heriberto Enríquez y Ceboruco se presenta la problemática de un tráfico excesivo por las mañanas de 6:50 a 9:00 am y por las tardes de las 19:00 a las 21:00 horas, lo que provoca contaminación auditiva ya que los automovilistas tienden a pitar el claxon muchas veces sin parar hasta que avanzan, así como contaminación visual ya que nos llega exceso de información en colores y luces de los vehículos, lo que provoca que nuestro cerebro no pueda procesarla debidamente y, al final, todo ello nos perjudica. Este fenómeno afecta no sólo a los automovilistas, sino que también a los alumnos del plantel “Dr. Angel Ma. Garibay Kintana” ya que propicia estrés y a su vez quizá una disminución en su rendimiento académico.
            </p>
            <div class="row pb-1">
                <div class="col-4" id="contenedor1">
                    
                </div>
                <div class="col-8">
                    <p>
                    Una de las principales causas de este problema además del exceso de vehículos, es que los semáforos que se ubican en las esquinas de estas calles están totalmente desincronizados y duran muy poco para que los automóviles puedan pasar. Otro factor muy importante es la hora de entrada y de salida de los alumnos de la escuela preparatoria ya que los padres estacionan sus autos por ambos lados de las calles entorpeciendo el tránsito
                    </p>
                </div>
            </div>
            
            <p class="pb-2">
                Sin entrar a plantear soluciones específicas, este documento pretende analizar cuáles son los factores y las consecuencias del tráfico, verdadera desgracia moderna de las zonas urbanas y amenaza para la calidad de vida de sus habitantes.
            </p>
        </div>
        <!--PLANTEAMINETO DEL PROBLEMA-->
        <div class="text-justify">
            <h5 class="p-2 text-center">PLANTEAMINETO DEL PROBLEMA</h5>
            <p class="p-2 text-center">
                Cómo el tráfico en las calles de Heriberto Henríquez y Ceboruco afecta de manera visual y auditiva a los alumnos del plantel “Dr. Ángel Ma. Garibay Kintana” y a la biodiversidad ambiental.
            </p>
            <p class="pb-2">En los últimos años el aumento de la demanda de transporte y del tránsito vial han traído como consecuencia la congestión en términos de pérdida de eficiencia económica sumándole sus consecuencias negativas para la sociedad, ya que el tráfico en las calles de Heriberto Henríquez y Ceboruco afecta de manera visual y auditiva a los alumnos del plantel “Dr. Ángel Ma. Garibay Kintana” y a su entorno ambiental,  abarcando aspectos económicos, psicológicos,  ecológicos y de salud. De tal forma que es necesario que se reduzca el tráfico y a su vez la contaminación del medio ambiente.  </p>
        </div>
        <!--justificacion-->
        <div>
            <h5 class="p-2 text-center">JUSTIFICACIÓN</h5>
            <p class="p-2">
                El tema de investigación fue elegido por ser un problema social de actualidad. El presente trabajo tiene como finalidad el análisis de las afecciones por el tráfico a los alumnos del Plantel 5 “Dr. Ángel Ma. Garibay Kintana” y la repercusión al medio ambiente y a la biodiversidad.
            </p>
            <p class="pb-2">
                Es necesario hacer mención que el uso de transportes a gasolina de manera irresponsable es un problema del que no muchos son conscientes. Si nos percatáramos de cuanto tiempo invertimos en el traslado a nuestros destinos y la producción de CO2 que esto ocasiona por cada alumno, nos daríamos cuenta del impacto que tiene en la naturaleza y en nuestra salud, que a largo plazo va en aumento.  
            </p>
        </div>
        <!--objetivos-->
        <div>
            <h5 class="pb-2 text-center">OBJETIVOS</h5>
            <h6 class="pb-1">Generales</h6>
            <p class="p-1">
                1.- Lograr que se disminuya el trafico en las calles de Heriberto Henríquez y Ceboruco.
            </p>
            <p class="pb-1">2.	Reducir la contaminación afecta de manera visual y auditiva a los alumnos del Plantel 5 “Dr. Ángel Ma. Garibay Kintana” y a su entorno ambiental. </p>
            <p class="pb-1">3.	Mejorar el desempeño académico de los alumnos del plantel. </p>
            <h6 class="pb-1">Especificos</h6>
        ...
        <!--hipotesis-->
        <div>
            <h5 class="pb-2 text-center">HIPÓTESIS</h5>
            <p class="pb-2">
                Los alumnos del Plantel 5 “Dr. Ángel Ma. Garibay Kintana” aumentarían su aprovechamiento académico si los efectos del trafico en las calles de Heriberto Enríquez y Ceboruco disminuyen. 
            </p>
            <p class="pb-2">
                Con la disminución de los niveles de trafico en las calles de Heriberto Enríquez y Ceboruco se podría recuperar la biodiversidad en el Plantel 5 “Dr. Ángel Ma. Garibay Kintana”.
            </p>
        </div>
        <!--ARGUMENTACIÓN TEÓRICO – METODOLÓGICA-->
        <div>
            <h5 class="pb-2 text-center">ARGUMENTACIÓN TEÓRICO – METODOLÓGICA</h5><br>
        <h6 class="pb-2">¿Cuáles son las afectaciones de esta problemática?</h6>
            <p class="pb-2">En los últimos años, especialmente desde principios de los años noventa, el aumento de la demanda de transporte y del tránsito vial han causado, particularmente en las ciudades grandes, más congestión, demoras, accidentes y problemas ambientales. Ese aumento explosivo surge de un mayor acceso al automóvil, al elevarse el poder adquisitivo, más acceso al crédito, reducción de los precios de venta, más oferta de autos usados, crecimiento de la población, menos habitantes por hogar y escasa aplicación de políticas estructuradas en el transporte urbano.</p>
            <p class="pb-2">La contaminación urbana de los países en vía de desarrollo podría parecer a simple vista un tema trivial e intrascendente, si no fuese porque la población que albergan muestra un crecimiento exponencial superior al nacional y al mundial (Naciones Unidas, 2004)</p>

        <h6 class="pb-2"> Contaminación auiditiva</h6>
            <p class="pb-2">A la contaminación por ruido, de manera particular, se le ha prestado muy poca atención por cuanto la condición emerge lentamente, rara vez requiere de atención médica inmediata y no es fatal. Sin embargo y, a manera de ejemplo, entre 1980 y 1990 por lo menos 4 millones de trabajadores en Estados Unidos fueron expuestos a niveles de ruido conducentes a la pérdida auditiva (Committee to Review the NIOSH Hearing Loss Research Program, 2006).</p>
            <div class="row pb-1">
                <div class="col-5">
                    <img src="trafico-teorico.png" width="300" height="400"alt="">
                </div>
                <div class="col-7">
                    <p>El ruido proveniente del trasporte vehicular constituye la principal fuente emisora de este contaminante en las ciudades, producto de la necesidad de movilización diaria de millones de personas a la escuela o al trabajo, además de los requerimientos de transporte para soporte del sistema industrial, comercial, de servicios y administrativo. Mientras una conversación normal transcurre aproximadamente a 55 decibeles (dBA) (Gandía, 2003), el ruido vehicular de muchas ciudades del mundo alcanza entre 80 y 90 dBA, equiparándose incluso en algunos casos, con el de un taladro neumático.</p>
                </div>
            </div>
            <p class="pb-2">Genera discapacidades y cambios en el comportamiento. Incluye problemas de concentración, fatiga, pérdida de confianza, irritación, malentendidos, pérdida de capacidad de trabajo, problemas de relaciones humanas y estrés. </p>
            <p class="pb-2">Una conversación normal ocurre de 50 a 55 dBA y para que la inteligibilidad de una conversación sea adecuada, la relación entre habla y ruido debe ser menor a 15 – 18 dBA. Los ruidos superiores a 35 o 40 dBA, provocan dificultades en la comunicación oral y, a partir de 65 dBA, las conversaciones se tornan extremadamente difíciles (OMS, 1999).</p>
            <p class="pb-2">Ha sido ampliamente documentado que la exposición al ruido afecta las capacidades de atención, motivación, memoria, lectura y desempeño en tareas cognitivas complejas, hecho que induce a un mayor número de accidentes. </p>
            <p class="pb-2">En México, por ejemplo, millones de personas pierden más de dos años de su vida atascados en el tráfico. En el portal Comunidad Vial México se asegura que hay ciudadanos que pasan hasta cuatro o más horas diarias en medio de largas filas de autos en avenidas y calles en la metrópoli. Las personas jóvenes son más propensas a sufrir estrés por el tráfico vehicular, debido al manejo inadecuado de cuadros de irritabilidad, ansiedad y angustia.</p>

        <h6 class="pb-2"> La contaminación visual </h6>
            <p class="pb-2">Estamos tan acostumbrados a ella que no nos damos cuenta de que nos enferma y nos afecta anímicamente. Especialmente en las ciudades, la contaminación visual está en todas partes, en todos los entornos, hacia cualquier lado que volteemos.</p>
            <p class="pb-2">Este tipo de contaminación afecta o perturba la vista de algún sitio o paisaje, destruye su estética y su esencia original; ocurre porque existe un abuso de elementos no arquitectónicos que alteran la imagen rural, urbana, y de cualquier entorno.</p>
            <p class="pb-2">Datos de la Organización Mundial de la Salud (OMS) indican que 40% de quienes habitan un departamento u oficina con paisajes desagradables, tiende a deprimirse, lo que significa que la contaminación visual puede afectar nuestra salud de manera considerable.</p>
            <p class="pb-2">“Los humanos necesitamos a la vista cosas naturalmente hermosas, como las aves, los árboles o el cielo para sentirnos bien anímicamente, con tranquilidad y sin estrés, pero la mayoría de las veces los grandes edificios nos impiden llenarnos la pupila con un entorno bello” (Jorge Márquez,2019) </p>
            <p class="pb-2">Un estudio publicado en la revista Epidemiology muestra que los niveles diarios de dióxido de nitrógeno (NO2) y carbono elemental (o carbono negro), dos de los contaminantes asociados al tráfico, producen fluctuaciones en la función de la atención en alumnos.</p>
            <p class="pb-2">El punto de partida de este estudio era un trabajo anterior que establecía una relación entre la exposición de alumnos a la contaminación atmosférica procedente del tráfico y el desarrollo de la función de la atención y la memoria de trabajo a largo plazo.</p>
            <p class="pb-2">El análisis de los resultados muestra que los incrementos en los niveles ambientales de los contaminantes procedentes del tráfico están asociados con una disminución en todos los procesos de atención dentro de las aulas.</p>
            <p class="pb-2">La contaminación acústica en los centros educativos es la suma de tres problemas que se agravan entre sí. El primer factor es el ruido procedente de fuentes externas (calles, obras, tráfico, etc.) Eso hace que el volumen de voz de alumnos y profesores se eleve e incluso se deba de detener la clase creando el segundo problema, y por último, el tercer factor que incide en las aulas es la reverberación: el efecto producido por los rebotes de la onda sonora en paredes, piso, techo y todos los objetos del aula, que hace que el alumno no sólo reciba el mensaje hablado en forma directa, sino innumerables copias de ese mensaje, fruto de la reflexión sobre paredes y objetos del recinto.</p>
       
        <h6 class="pb-6">Biodiversidad</h6>
            <p class="pb-2">La elección de un hábitat por parte de los animales depende, y mucho, de los ruidos que se producen en él. Si un animal no puede tolerar el ruido del entorno, no tolerará ninguna de sus condiciones. Eso hace que la contaminación acústica de vehículos, fábricas, talado de árboles o turismo altere el delicado equilibrio de los ecosistemas salvajes.</p>
            <p class="pb-2">Si los animales en los escalones más bajos de la pirámide alimentaria huyen, tras ellos se marchan sus depredadores. Si son los depredadores los que se ven afectados por la contaminación acústica, sus presas empiezan a crecer fuera de control. Eso empieza a afectar también a la flora, cambiando por completo paisajes y zonas.</p>
            <p class="pb-2">Los pájaros en una ciudad necesitan cantar y llamar de manera más prolongada (y a mayor volumen), que su misma especie cuando vive en el campo. De hecho, debido a la contaminación acústica, algunas especies como el petirrojo europeo que vive en ciudades ha comenzado a cantar de noche, para que se le oiga y pueda sobrevivir reproduciéndose. </p>
            <p class="pb-2">No son las únicas especies que se ven afectadas. Se ha estudiado cómo el ruido del tráfico afecta también al proceso reproductivo de las ranas en zonas metropolitanas. Ese ruido ahoga las llamadas de apareamiento de los machos, de manera que no pueden perpetuarse.</p>
            <p class="pb-2">Una gran parte de nuestra vida es desperdiciar horas y horas a la semana metido en el coche para llegar al trabajo, a la escuela y al hogar. En las calles de Heriberto Henríquez y Ceboruco se desperdician aproximadamente 15 minutos extras en trayectos por culpa del tráfico, lo que es demasiado tiempo, que se suma a los niveles de contaminación atmosférica, efecto invernadero y lluvia ácida que provocan las grandes concentraciones de gases que emiten los coches. </p>
        
    
        <h6 class="pb-2">A la salud</h6>
            <p class="pb-2">Cuando se habla de riesgos para la salud asociados al tráfico siempre nos centramos en las muertes y discapacidades asociadas a los accidentes de circulación. </p>
            <div class="row pb-1">
                <div class="col-5">
                    <img src="trafico-salud.png" width="300" height="400">
                </div>
                <div class="col-7">
                        <p class="pb-2">Sin embargo, estudios realizados en varios países de la Comunidad Europea demuestran que la contaminación producida por el tráfico es responsable de más muertes que las producidas por los accidentes. (Madrid Salud. (11/09/2018) comunidad Europea.)</p>
                        <p class="pb-2">Muchas son las causas que asocian el tráfico de vehículos a motor con aumento de la mortalidad y de los ingresos hospitalarios de entre ellas, las más significativas y estudiadas, son las producidas por los gases emitidos por los motores (estrés cardiaco, arterioesclerosis, aumento de crisis asmáticas, alergias respiratorias etc.), el ruido o las consecuencias derivadas del sedentarismo.</p>
                </div>
            </div>
            <p class="pb-2">La exposición constante al ruido del tráfico produce elevaciones de la tensión arterial y de niveles en sangre de hormonas ligados al estrés, produciendo aumento de ingresos hospitalarios y muertes por enfermedades cardiovasculares. También es responsable de otras alteraciones respiratorias, neurológicas, dermatológicas y digestivas. También, se ve afectada la salud de los ojos hasta la del cerebro por la gran cantidad de luces de los faros de los autos.</p>
    
        <h6 class="pb-2">Economia</h6>
            <p class="pb-2">Este fenómeno afecta no sólo a los automovilistas ya que entre más tiempo se tarden en el tráfico, más gasolina consumirán sus autos y por ende gastaran más, también afecta a los usuarios del transporte colectivo, que son personas de ingresos menores, pues aumenta sus tiempos de viaje y, quizás de mayor consideración, hace subir el valor de los pasajes.</p>
            <div class="row pb-1">
                <div class="col-5">
                    <img src="gasolineria.jpg" width="300" height="150" alt="">
                </div>
                <div class="col-7">
                    <p class="pb-2">Con estos datos, es fácil entender por qué la movilidad urbana y la gestión de la circulación de vehículos se ha convertido en uno de los grandes retos que deben afrontar las urbes.</p>
                </div>
            </div>
            
        <h6 class="pb-2">SOLUCIONES</h6>
            <p class="pb-2">Las soluciones tradicionales -construir más calles - no bastarán para superar el crecimiento del tránsito en Toluca, de modo que es necesario implementar múltiples soluciones simultáneamente para evitar el colapso de las redes de transporte.  Se necesitan nuevas técnicas que permitan a los funcionarios de la red vial entender mejor y manejar proactivamente el flujo del tránsito.</p>
            <p class="pb-2">Las nuevas tecnologías se presentan como la única opción viable para racionalizar los traslados y el movimiento de los coches en las ciudades. Carolina Osorio, profesora e investigadora del MIT, lleva tiempo trabajando en buscar soluciones a este problema. Para ello ha ideado un algoritmo que recoge la información proporcionada por las cámaras y sensores instalados en distintas ciudades, y propone mejoras en la gestión del tráfico.</p>
            <div class="row">
                <div class="col-5">
                    <img src="trafico-soluciones.jpg" width="300" height="400" alt="">
                </div>
                <div class="col-7">
                    <p class="pb-2">Una alternativa que es factible es mejorar el sistema de tránsito por medio de semáforos inteligentes que den prioridad a las calles con más tráfico para así evitarlo; además estos semáforos inteligentes pueden alimentarse de energía solar lo cual beneficia al medio ambiente y a su vez se disminuirían los niveles de contaminación atmosférica por gases de 〖CO〗^2.</p>
                    <p class="pb-2">Ver cómo podemos programar la red de estos semáforos que conectan a las calles de forma que no se genere una congestión vehicular, pero también que el flujo dentro de la colonia y calles aledañas no se vea afectado. </p>
                </div>
            </div>
        </div>
        <!--cronograma-->
        <div>
            <h5 class="p-2 text-center">CRONOGRAMA</h5>
...
<div>
    ...
    <div>
        <img width="600" height="300" src="Grafica-1.png">
    ...
    <div>
        <img width="600" height="300" src="Grafica-2.png" alt="">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-3.png">
        <p class="p-2 text-justify">
     ...
     <div>
         <img width="600" height="300" src="Grafica-4.png">
         <p class="p-2 text-justify">
     ...
     <div>
         <img width="600" height="300" src="Grafica-5.png" alt="" srcset="">
         <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-6.png" alt="">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-7.png">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-8.png">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-9.png">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-10.png" alt="">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-11.png" alt="">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-12.png" alt="">
        <p class="p-2 text-justify">
    ...
    <div>
        <img width="600" height="300" src="Grafica-13.png" alt="">
        <p class="p-2 text-justify">
...
},{"./calculo":15,"./cultura":17,"./derecho":20,"./fisica":22,"./homepage":24,"./optativas":30,"./optativas/estrategias":28,"page":11}],28:[function(require,module,exports){
var page = require('page');
...
},{"./template":29,"empty-element":3,"page":11}],29:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"./template":31,"empty-element":3,"page":11}],31:[function(require,module,exports){
yo = require('yo-yo');
module.exports = yo`
 <div class="container">
